...
/// <summary>
/// An interface that defines methods and properties for managing line indentation in a text file.
/// </summary>
internal interface IIndentProcessor
{
    ...
    /// </returns>
    /// <remarks>
    /// If the <paramref name="firstTimeOffset" /> value is zero, then this method will return the
    /// indent value as determined by the <see cref="GetIndent(TextItem)" /> method.
    /// </remarks>
    ...
    /// <summary>
    /// Determines whether or not the given string value represents a valid integer indent value.
    /// </summary>
    ...
    /// </param>
    /// <returns>
    /// <see langword="true" /> if the <paramref name="stringValue" /> was successfully converted to
    /// a valid indent value. Otherwise, returns <see langword="false" />.
    /// </returns>
    /// <remarks>
    /// The <paramref name="indent" /> parameter will be set to 0 if <paramref name="stringValue" />
    /// can't be converted to a valid indent value.
    /// </remarks>
    ...
    /// </param>
    /// <returns>
    /// <see langword="true" /> if the <paramref name="stringValue" /> parameter was successfully
    /// converted to a valid tab size value.
    /// </returns>
    /// <remarks>
    /// The <paramref name="tabSize" /> will be set to 0 if <paramref name="stringValue" /> can't be
    /// converted to a valid tab size value.
    /// </remarks>
    ...
    /// </param>
    /// <remarks>
    /// The tab size will be constrained to fall within the minimum and maximum values defined in
    /// the <see cref="IndentProcessor" /> class definition.
    /// </remarks>
