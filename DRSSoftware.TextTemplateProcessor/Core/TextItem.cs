...
/// <summary>
/// The <see cref="TextItem" /> record represents a single line of text from a text template file.
/// The record contains the text that will be written to the output file along with information used
/// to control the indentation of that text line.
/// </summary>
/// <param name="Indent">
...
/// current text line and the current indent value carried forward from the previous text line is
/// passed on unchanged to the next text line. <br /> If <see langword="false" />, the specified
/// <paramref name="Indent" /> value adjusts the current indent value carried forward from the
/// previous text line before being passed on to the next text line.
/// </param>
/// <param name="Text">
