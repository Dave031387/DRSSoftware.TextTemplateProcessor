...
internal static class Messages
{
    ...
    internal const string MsgTabSizeValueOutOfRange = $"The tab size must be an integer between {MinTabSizeString} and {MaxTabSizeString}, but the specified value was {{0}}.";
